    ...
    return (
      <div>
        <Router>
          <NavBar/>
          <Routes>
            {/* <Route path="/"><News pageSize={5} country="in" category="general" element={</>}/></Route> */}
            ...
            {/* <Route path="/entertainment"><News pageSize={5} country="in" category="entertainment" element={<E/>}/></Route>
            <Route path="/general"><News pageSize={5} country="in" category="general" element={<Home/>}/></Route>
            <Route path="/health"><News pageSize={5} country="in" category="health" element={<Home/>}/></Route>
            <Route path="/science"><News pageSize={5} country="in" category="science" element={<Home/>}/></Route>
            <Route path="/sports"><News pageSize={5} country="in" category="sports" element={<Home/>}/></Route>
            <Route path="/technology"><News pageSize={5} country="in" category="technology" element={<Home/>}/></Route> */}
          </Routes>
        </Router>
      </div>
    )
